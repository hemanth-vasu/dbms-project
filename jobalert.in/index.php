    ...
    <div class="container">
        <div class="container bg-dark p-2">
            <div class="container " id="search">
                ...
                <form class="form-inline m-4" action="search.php" method="GET">
                    <input name="job_name" class="form-control ml-2"
                        style="width:88%;height:3rem;background-color:#fedc19;" type="search"
                        placeholder="Search Jobs Here..." aria-label="Search">
                    <button class="btn btn-light ml-2 p-2 pl-4 pr-4" type="submit">Search</button>
                </form>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <span class="card-title card-header-name font-weight-bold"><i class="far fa-building card-header-name"></i> &nbsp;&nbsp;&nbsp;&nbsp;'.$comp_name.'</span>
